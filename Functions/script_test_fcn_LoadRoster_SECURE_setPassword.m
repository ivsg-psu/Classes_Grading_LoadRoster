% script_test_fcn_LoadRoster_SECURE_setPassword.m
% tests fcn_LoadRoster_SECURE_setPassword.m
...
props = fcn_LoadRoster_SECURE_setPassword(props); 

assert(~isstruct(props));
...
%     fcn_LoadRoster_SECURE_setPassword(...
%     tempXYdata,...
%     start_definition,...
%     end_definition,...
